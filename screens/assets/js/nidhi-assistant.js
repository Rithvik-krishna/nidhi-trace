    ...
    function createAssistantDOM() {
        ...
        root.innerHTML = `
            ...
            <div id="nidhi-floating-container" class="fixed z-[9990] flex items-center gap-2 group touch-none" style="bottom: 76px; right: 24px; cursor: grab;">
                ...
                <button id="nidhi-assistant-toggle" type="button" aria-label="Open NIDHI Audit Assistant" class="w-[50px] h-[50px] rounded-full bg-brand-900 hover:bg-slate-800 text-white shadow-xl hover:shadow-2xl flex items-center justify-center transition-all duration-200 hover:scale-105 active:scale-95 border border-blue-500/30 cursor-pointer relative">
